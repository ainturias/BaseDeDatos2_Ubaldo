...
-- INSERTADO PARA PROBAR SI FUNCIONA EL PROCEDIMIENTO DEL EJERCICIO 11 --
-- Inserciones en la tabla pventas
INSERT INTO pventas (nvta, nomc, calm, ftra, itot, ides)
VALUES (1, 'Cliente1', 1, '2023-07-11', 100.00, 10.00);

INSERT INTO pventas (nvta, nomc, calm, ftra, itot, ides)
VALUES (2, 'Cliente2', 2, '2023-07-12', 200.00, 20.00);

INSERT INTO pventas (nvta, nomc, calm, ftra, itot, ides)
VALUES (3, 'Cliente3', 1, '2023-07-13', 150.00, 15.00);

INSERT INTO pventas (nvta, nomc, calm, ftra, itot, ides)
VALUES (4, 'Cliente4', 2, '2023-07-14', 300.00, 30.00);

INSERT INTO pventas (nvta, nomc, calm, ftra, itot, ides)
VALUES (5, 'Cliente5', 3, '2023-07-15', 250.00, 25.00);

INSERT INTO pventas (nvta, nomc, calm, ftra, itot, ides)
VALUES (6, 'Cliente6', 4, '2023-07-16', 180.00, 18.00);

INSERT INTO pventas (nvta, nomc, calm, ftra, itot, ides)
VALUES (7, 'Cliente7', 2, '2023-07-17', 220.00, 22.00);

-- Inserciones en la tabla dventas
INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (1, 1, 5, 10.00, 50.00);

INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (1, 2, 3, 15.00, 45.00);

INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (2, 3, 2, 20.00, 40.00);

INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (3, 1, 4, 12.50, 50.00);

INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (3, 3, 2, 18.75, 37.50);

INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (4, 2, 5, 15.00, 75.00);

INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (5, 4, 3, 25.00, 75.00);

INSERT INTO dventas (nvta, cprd, cant, prec, impt)
VALUES (7, 5, 4, 17.50, 70.00);
